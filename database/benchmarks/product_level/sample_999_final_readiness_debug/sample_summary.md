...
- Sample ID: 999
- Sample Label: final_readiness_debug
- Output Folder: database/benchmarks/product_level/sample_999_final_readiness_debug
- Companies: 6
- Modes: llm, rag
- Max Depth: 3
- Skip News: True
...
- Total rows: 34
- Successful rows: 34
- Quantitatively evaluated rows: 6
- Not evaluable due to missing reference: 28
- Failed rows: 0
- Quota-exhausted rows: 0
- Partial-success rows: 0
...
- Tier 2 rows with discovery output: 18
- Tier 3 rows with discovery output: 10
- Tier 2 output includes discovered suppliers, verified suppliers, confidence, and paths.
- Tier 3 output includes discovered suppliers, verified suppliers, confidence, and paths.